...
public class TextTournamentUI implements TournamentUI
{
    ...
    public synchronized void tournamentFinished(List<ParticipantInfo> sortedParticipants)
    {
        ...
        String[] authors = s1.getAuthors();
        if (authors != null)
        {
            for (String author : s1.getAuthors())
            {
                out.print("\n    " + author);
            }
        }
        out.println("");
        out.println("\n" + s2.getID() + " - " + s2.getName());
        authors = s2.getAuthors();
        if (authors != null)
        {
            for (String author : s2.getAuthors())
            {
                out.print("\n    " + author);
            }
        }
        ...
        authors = p1.getAuthors();
        if (authors != null)
        {
            for (String author : p1.getAuthors())
            {
                out.print("\n    " + author);
            }
        }
        ...
        authors = p2.getAuthors();
        if (authors != null)
        {
            for (String author : p2.getAuthors())
            {
                out.print("\n    " + author);
            }
        }
    ...
    private void printPlace(int place, ParticipantInfo p)
    {
