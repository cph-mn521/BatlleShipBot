...
public interface BattleshipsPlayer
{
     ...
     * rounds being played, the number and size of the ships and the size of the board.
     * @param rounds int the number of rounds i a match
     * @param ships a fleet representing the ships in play
     ...
     * @param points your points this round: SizeX * SizeY - number of shot used
     * to sink all of the enemy's ships. 
     *
